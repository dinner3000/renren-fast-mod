layui.config({
  base:'js/'
	...
	$(window).on('resize', function() {
		var $content = $('#larry-tab .layui-tab-item');
	...
	$(function(){
		$(".left-menu").on("click","a",function(e){
			...
			var parent_el = $(this).closest("dd");
			if(parent_el.size() == 0){
				//一级菜单
				var super_el =  $(this).closest("li");
				if (super_el.hasClass('layui-nav-itemed')) {
					super_el.removeClass("layui-nav-itemed");
				}else{
					super_el.addClass("layui-nav-itemed");
				}
				//super_el.addClass("layui-nav-itemed").siblings().removeClass("layui-nav-itemed");
