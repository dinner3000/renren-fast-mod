package com.brh.workflow.engine.diagram;
	...
	static {
		...
		activityDrawInstructions.put("startEvent", new ActivityDrawInstruction() {
			...
			public void draw(ProcessDiagramCanvas processDiagramCreator, ActivityImpl activityImpl) {
				activityImpl.setWidth(activityImpl.getWidth()+15);
				activityImpl.setHeight(activityImpl.getHeight()+15);
				processDiagramCreator.drawNoneStartEvent((String) activityImpl.getProperty("name"),activityImpl.getX(), activityImpl.getY(), activityImpl.getWidth(), activityImpl.getHeight());
			}
		});
		...
		activityDrawInstructions.put("endEvent", new ActivityDrawInstruction() {
			...
			public void draw(ProcessDiagramCanvas processDiagramCreator, ActivityImpl activityImpl) {
				activityImpl.setWidth(activityImpl.getWidth()+15);
				activityImpl.setHeight(activityImpl.getHeight()+15);
				processDiagramCreator.drawNoneEndEventWithName((String) activityImpl.getProperty("name"),activityImpl.getX(), activityImpl.getY(), activityImpl.getWidth(), activityImpl.getHeight());
			}
		});
		...
		activityDrawInstructions.put("errorStartEvent", new ActivityDrawInstruction() {
			...
			public void draw(ProcessDiagramCanvas processDiagramCreator, ActivityImpl activityImpl) {
				processDiagramCreator.drawErrorStartEvent((String) activityImpl.getProperty("name"),activityImpl.getX(), activityImpl.getY(), activityImpl.getWidth(), activityImpl.getHeight());
			}
		});
