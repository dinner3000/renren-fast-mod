...
public class ProcessDiagramCanvas {
	...
	public void drawNoneStartEvent(String name, int x, int y, int width,
		...
		drawStartEventWithName(name, x, y, width, height, null);
	}
	...
	public void drawStartEventWithName(String name, int x, int y, int width,
	...
	public void drawNoneEndEvent(int x, int y, int width,
			int height) {
	...
	public void drawNoneEndEventWithName(String name, int x, int y, int width,
			int height) {
		Stroke originalStroke = g.getStroke();
		g.setStroke(END_EVENT_STROKE);
		g.draw(new Ellipse2D.Double(x, y, width, height));
	...
	public void drawErrorEndEvent(int x, int y, int width,
			int height) {
	...
	// 增加name
	public void drawErrorStartEvent(String name, int x, int y, int width,
			int height) {
		drawNoneStartEvent(name, x, y, width, height);
