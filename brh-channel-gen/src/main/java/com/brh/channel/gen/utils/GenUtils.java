package com.brh.channel.gen.utils;
...
import com.brh.channel.gen.entity.ColumnEntity;
import com.brh.channel.gen.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, Object> table,
		...
		table=CamelUtils.toReplaceKeyLow(table);
		//表信息
		...
		for(Map<String, Object> column : columns){
			column=CamelUtils.toReplaceKeyLow(column);
