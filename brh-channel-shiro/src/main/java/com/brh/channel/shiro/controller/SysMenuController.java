...
import com.brh.channel.common.utils.CommonConstant.MenuType;
...
import com.brh.channel.shiro.service.SysMenuService;
...
public class SysMenuController extends AbstractController {
	...
	/**
	 * 分页查询所有菜单列表   暂时不用了20180118 payment-2218
	 */
	@RequestMapping("/list")
	@RequiresPermissions("sys:menu:list")
	public R list(@RequestParam Map<String, Object> params){
		logger.info("菜单查询开始{}"+params.toString());
		//查询列表数据
		...
		logger.info("菜单查询结束{}"+params.toString());
	...
	public R perms(){
		...
		//只有超级管理员，才能查看所有管理员列表
		if(getUserId() == CommonConstant.SUPER_ADMIN){
	...
	public R delete(@RequestBody Long[] menuIds){
		...
		if (dbTyp.equals("mysql")) {
		sysMenuService.deleteBatch(menuIds);
		}else if(dbTyp.equals("oracle")){
			sysMenuService.deleteBatchRoleAndMenu(menuIds);
		}
