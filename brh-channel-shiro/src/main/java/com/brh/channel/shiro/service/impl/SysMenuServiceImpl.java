...
import com.brh.channel.shiro.dao.SysMenuDao;
...
public class SysMenuServiceImpl implements SysMenuService {
	...
	@Override
	public void deleteBatchRoleAndMenu(Long[] menuIds) {
		sysMenuDao.deleteBatchMenu(menuIds);
		sysMenuDao.deleteBatchRoleMenu(menuIds);
